...
public class FacturacionLegacyTest {
    ...
    public void testClienteVipSinDescuentoExtra() {
        ...
        assertEquals(85.0, facturacion.cT(100.0, 1, false), 0.001,
    ...
    public void testClienteEstandar() {
        ...
        assertEquals(95.0, facturacion.cT(100.0, 2, false), 0.001,
                "Fallo: El cliente Estándar debe pagar 95.0");
        assertEquals(95.0, facturacion.cT(100.0, 2, true), 0.001,
                "Fallo: El cliente Estándar debe pagar 95.0 " +
"independientemente de dV");
    }

    @Test
    public void testClienteSinCategoria() {
        // tC = 3 -> 0% descuento. 100 - 0 = 100
        assertEquals(100.0, facturacion.cT(100.0, 3, false), 0.001,
                "Fallo: Un cliente sin categoría conocida no tiene " +
"descuento.");
    }
    ...
    public void testImporteNegativoOCero() {
        // m <= 0 -> 0
        assertEquals(0.0, facturacion.cT(0.0, 1, true), 0.001,
                "Fallo: Importe 0 debe devolver 0");
        assertEquals(0.0, facturacion.cT(-50.0, 2, false), 0.001,
